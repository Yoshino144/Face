...
class Model:
    ...
    def build_model(self, dataset, nb_classes=5):
        ...
        self.model.add(Convolution2D(32, 3, 3, border_mode='same',input_shape=dataset.input_shape))  # 1 2维卷积层 卷积核 个数，大小，步长
        #self.model.add(Conv2D(32, (3, 3), padding="same", input_shape=dataset.input_shape))  # 1 2维卷积层 卷积核 个数，大小，步长
