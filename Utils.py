...
def CheckVersion():
    ...
    import platform
    print("System: {}".format(platform.version()))
    ...
    import dlib
    print("Dlib: {}".format(dlib.__version__))

    import tensorflow
    print("Tensorflw: {}".format(tensorflow.__version__))
    ...
    import skimage
    print("Scikit_image: {}".format(skimage.__version__))
